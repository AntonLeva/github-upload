...
#G = nx.triangular_lattice_graph(100,100)
...
#initial_infections = [u for u in G if 45<u<100]
...
times, D = sim.summary()
#
#imes is a numpy array of times.  
#
#D is a dict, whose keys are the entries in
...
ani.save('SIRV_animate.html', fps=5, extra_args=['-vcodec', 'libx264'])
